          ...
          <div className={classes.introInfo}>
            ...
            <div className={classes.info}>
              <Typography variant="h6">
                I have been a software engineer for 4 years, have a solid
                background in computer science, and I have a strong enthusiasm
                and curiosity for programming. Motivated by a sincere interest
                in how technology can transform our world, I am continuously
                looking for new tasks and chances to advance my knowledge and
                skills. Recognizing the enormous potential for technology to
                simplify and enhance our lives, I am dedicated to using my
                programming expertise to make a positive difference. I have a
                wide range of hobbies outside of work, such as chess, puzzles,
                riding, Linux, and mindfulness, all of which help to shape my
                well-rounded and original problem-solving style.
              </Typography>
            </div>
          </div>
        </div>
